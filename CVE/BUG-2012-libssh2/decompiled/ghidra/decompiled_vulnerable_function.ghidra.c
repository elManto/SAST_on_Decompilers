...
LAB_0012b977:
        *(undefined4 *)(param_1 + 0xd2b0) = 0xf;
        local_8c = _libssh2_transport_send(param_1,&packet_20119,1,0,0);
...
LAB_0012c25a:
          *(undefined4 *)(param_1 + 0xd2b0) = 0xd;
          local_8c = packet_x11_open(param_1,param_2,param_3,param_1 + 0xd328);
        }
      }
      else {
...
LAB_0012c1a4:
        *(undefined4 *)(param_1 + 0xd2b0) = 0xc;
        local_8c = packet_queue_listener(param_1,param_2,param_3,param_1 + 0xd2c0);
      }
    }
    if (local_8c == 0xffffffdb) {
      uVar6 = 0xffffffdb;

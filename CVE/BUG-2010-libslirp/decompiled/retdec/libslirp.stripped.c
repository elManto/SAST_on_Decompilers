...
int32_t function_2e00(int32_t ver, char * filename, struct stat64 * stat_buf);
...
int64_t function_8b39(int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5) {
    ...
    if (a1 == 0 || v3 != 3 == (v3 != 11)) {
        ...
        if ((*(int32_t *)&g58 & 2) != 0) {
            ...
            in2 = (struct {int32_t e0;}){
                .e0 = 0
            };
            in2.e0 = *(int32_t *)(v6 + 16);
...
int64_t slirp_connection_info(int64_t a1) {
    ...
    if (v54 != v53) {
        ...
        in6 = (struct {int32_t e0;}){
            .e0 = 0
        };
        in6.e0 = *(int32_t *)(v56 + 76);
